...
\ProvidesExplFile{ctuthesis-titles.def}{2014/01/18}{0.1}{"Titles" part of the class ctuthesis}
...
\definecolor{ctubluetext}{RGB}{0,122,195}
\definecolor{ctubluerule}{named}{ctubluetext}
\definecolor{ctubluedarkbg}{named}{ctubluetext}
\definecolor{ctubluedot}{RGB}{172,214,238}
%\definecolor{ctubluebg}{RGB}{204, 235, 255}
\colorlet{ctubluebg}{ctubluedot!50!white}
\definecolor{ctugray}{named}{gray}
...
\DeclareDocumentEnvironment { theindex } { } {
	...
	\begin{multicols*}{2}
	\let\item\@idxitem
	% Do not put index sections in ToC
...
\newcommand\ctu@savetocdepth{\xdef\ctu@tocdepth{\the\c@tocdepth}}
\newcommand\ctu@restoretocdepth{\c@tocdepth\ctu@tocdepth\relax}
