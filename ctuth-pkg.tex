...
\ProvidesExplFile{ctuth-pkg.tex}%
	{2015/03/08}{0.1 t1503080149}%MY TIMESTAMP HERE {0.1}
...
\ctuifswitch { layout-short } {
	\dim_const:Nn \g_ctuthesis_geometry_texthright_dim { 1.5\g_ctuthesis_geometry_textwidth_dim }
	\cs_new:Nx \ctuthesis_geometry_vmarginratio: {4\string :3}
} {
	\dim_const:Nn \g_ctuthesis_geometry_texthright_dim { 0.75\paperheight }
...
\RequirePackage [ a4paper ,
	...
	textwidth = \g_ctuthesis_geometry_textwidth_dim ,
 	textheight = \g_ctuthesis_geometry_texthright_dim ,
...
%		\ctuthesis_lst_orig_lstinline:w[#2]@#4@
		\hspace*{0pt}\end{lrbox}
		{\fboxsep0pt\colorbox{#1}{\strut\hspace*{0.2em}\box\ctuthesis_lst_box\hspace*{0.2em}}}
		\microtypesetup{activate=true}
	}
	\DeclareDocumentCommand \ctulst { D(){ctubluebg} O{} m } {
		\ctuthesis_lst_do_ctulstinline:nnw { #1 } { #2 } { #3 } #3
	}
	\DeclareDocumentCommand \ctulstbr { D(){ctubluebg} O{} m } {
		\leavevmode
		\begin{lrbox}{\ctuthesis_lst_box}
...
% Provide \microtype to make it available in case microtype wasn't loaded
