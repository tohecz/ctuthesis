...
\tl_map_inline:nn { {front-specification}{monochrome}{pkg-listings} } {
	\keys_define:nn { ctuthesis } {
		#1 .bool_gset:c = { g_ctuthesis_switch_#1_bool },
		#1 .initial:n = { false },
	}
}
\ctuthesis_keys_add_no:nn { nopost } { monochrome, pkg-listings }

% Switches defaulting to true
\tl_map_inline:nn { {front-list-of-tables}{front-list-of-figures}{pkg-hyperref} } {
	\keys_define:nn { ctuthesis } {
		#1 .bool_gset:c = { g_ctuthesis_switch_#1_bool },
		#1 .initial:n = { true },
	}
}
\ctuthesis_keys_add_no:nn { nopost } { monochrome, pkg-listings, pkg-hyperref }
...
\tl_map_inline:nn { {author}{supervisor}{supervisor-address}{day}{month}{year}
...
\cs_new:Npx \ctuverlog {
	ctuthesis ~ \use_ii:nn
	{2015/03/03}{ t1503030022}%MY TIMESTAMP HERE {}	
}
