...
\tl_map_inline:nn { {front-specification}{monochrome}{savetoner}{pkg-listings} } {
	\keys_define:nn { ctuthesis } {
...
\ctuthesis_keys_add_no:nn { nopost } { pkg-hyperref }
...
\cs_new:Npx \ctuverlog {
	ctuthesis ~ \use_ii:nn
	{2015/03/03}{ t1503032316}%MY TIMESTAMP HERE {}	
}
