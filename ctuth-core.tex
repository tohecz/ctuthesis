...
\cs_new_protected_nopar:Npn \ctuthesis__keys_filter:nnnN
  {  \ctutesis__@@_filter:onnnN \l_@@_unused_clist }
\cs_generate_variant:Nn \ctuthesis__keys_filter:nnnN { nnV , nnv , nno }
\cs_new_protected:Npn \ctuthesis__@@_filter:nnnnN #1#2#3#4#5
  {
    \clist_clear:N \l_@@_unused_clist
    \ctuthesis__keys_filter:nnn {#2} {#3} {#4}
    \tl_set:Nx #5 { \exp_not:o { \l_@@_unused_clist } }
    \tl_set:Nn \l_@@_unused_clist {#1}
  }
\cs_generate_variant:Nn \ctuthesis__@@_filter:nnnnN { o }
\cs_new_protected:Npn \ctuthesis__keys_filter:nnn #1#2#3
  {
  	\begingroup
...
\cs_generate_variant:Nn \ctuthesis__keys_filter:nnn { nnV , nnv , nno }
