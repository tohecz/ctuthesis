...
\ProvidesExplFile{ctuthesis-template.def}{2014/01/18}{0.1}{"Templates" part of the class ctuthesis}
...
\ctutemplateset{loft}{
	\begin{twocolumnfrontmatterpage}
		\selectctulanguage{main}
		\ctuifswitch { list-of-figures } { \listoffigures } { }
		\newpage
		\ctuifswitch { list-of-tables } { \listoftables } { }
	\end{twocolumnfrontmatterpage}
}
...
\ctutemplateset{maketitle}{
	...
	\ctuifswitch{specification-in-front}{
		\ctutemplate{include~specification}
		\cleardoublepage
	} { }
	...
	\bool_if:nTF { \ctuthesis_if_switch_p:n { list-of-figures } || \ctuthesis_if_switch_p:n { list-of-tables } } {
		\ctutemplate{loft}
	} { }
